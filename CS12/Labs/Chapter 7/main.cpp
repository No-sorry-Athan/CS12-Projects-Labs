...
int main() {
	...
	if (test == 6) {
		...
		cout << "List6: Selection sort" << endl;
		list6.selection_sort();
		cout << list6 << endl;
		cout << "Back" << list6.back() << endl;
		cout << "Front" << list6.front() << endl;
		cout << "22 ordered" << endl;
		list6.insert_ordered(22);
		cout << list6 << endl;
		cout << "Back" << list6.back() << endl;
		list6.insert_ordered(0);
		cout << list6 << endl;
		cout << "front" << list6.front() << endl;
		list6.pop_front();
		cout << list6 << endl;
